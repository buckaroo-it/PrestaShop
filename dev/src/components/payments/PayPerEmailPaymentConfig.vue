<template>
    <div>
        <div class="p-5 space-y-5">
            ...
            <div class="relative">
                <input type="number" id="frontend_label" class="block px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-900 bg-transparent rounded-lg border border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-fifthly peer" placeholder=" " v-model="config.due_days" />
                ...
                <div class="space-y-2">
                    ...
                    >
                        <input 
                            ...
                            class="w-4 h-4 text-fifthly bg-gray-100 border-gray-300 rounded focus:ring-fifthly focus:ring-2"
                        />
