<template>
    <div>
        ...
        <div class="p-5 space-y-5">
            ...
            <div class="relative">
                <select class="w-full rounded-lg border border-gray-300 p-2.5 peer" v-model="config.allowed_payments">
                    <option v-for="payment in payments" :value="payment.name">{{ payment.name }}</option>
                </select>
