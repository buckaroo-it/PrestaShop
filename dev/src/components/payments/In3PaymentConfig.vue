<template>
    <div>
        <div class="p-5 space-y-5">
            <div class="space-y-2">
                <h2 class="font-semibold text-sm">In3 version</h2>
            </div>

            <div class="relative">
                <select class="w-full rounded-lg border border-gray-300 p-2.5 peer" v-model="config.version">
                    <option value="V3">V3 (V3)</option>
                    <option value="V2">V2 (Capayable/In2)</option>
                </select>
        ...
        <div class="p-5 space-y-5" v-if="config.version === 'V3'">
          <h2 class="font-semibold text-sm">Payment logo</h2>
        ...
        const paymentLogoOptions = [
          {
            value: 'in3',
            text: 'IN3',
            image: '/modules/buckaroo3/views/img/buckaroo/Payment methods/SVG/In3.svg'
          },
          {
            value: 'in3_ideal',
            text: 'iDEAL In3',
            image: '/modules/buckaroo3/views/img/buckaroo/Payment methods/SVG/In3_ideal.svg'
          }
        ];
