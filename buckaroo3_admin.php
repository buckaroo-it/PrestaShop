...
class Buckaroo3Admin
{
    ...
    public function postProcess()
    {
        if (Tools::getValue('refresh_module')) {
            ...
            if ($idTab == 0) {
                $this->module->installModuleTab('AdminRefund', [1 => 'Buckaroo Refunds'], -1);
            }
    ...
    public function displayForm()
    {
        ...
        $fields_value['BUCKAROO_PGST_PAYMENT'] = [];
        $fields_value['BUCKAROO_PGBY_PAYMENT'] = [];
        $fields_value['BUCKAROO_IDIN_CATEGORY'] = [];
        ...
        foreach ($orderStatesGet as $o) {
            $orderStates[] = ['text' => $o['name'], 'value' => $o['id_order_state']];
        }
