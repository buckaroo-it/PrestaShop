...
class Buckaroo3Admin
{
    ...
    public function postProcess()
    {
        if (Tools::getValue('refresh_module')) {
            ...
            if (Tools::isSubmit('BUCKAROO_TEST')) {
                ...
                Configuration::updateValue('BUCKAROO_PAYGARANT_ENABLED', Tools::getValue('BUCKAROO_PAYGARANT_ENABLED'));
                Configuration::updateValue('BUCKAROO_PAYGARANT_TEST', Tools::getValue('BUCKAROO_PAYGARANT_TEST'));
                Configuration::updateValue('BUCKAROO_PAYGARANT_DATEDUE', Tools::getValue('BUCKAROO_PAYGARANT_DATEDUE'));
                Configuration::updateValue(
                    'BUCKAROO_PAYGARANT_SENDMAIL',
                    Tools::getValue('BUCKAROO_PAYGARANT_SENDMAIL')
                );
                ...
                Configuration::updateValue('BUCKAROO_PAYGARANT_USENOTIFICATION', Tools::getValue('BUCKAROO_PAYGARANT_USENOTIFICATION'));
                Configuration::updateValue('BUCKAROO_PAYGARANT_NOTIFICATIONDELAY', Tools::getValue('BUCKAROO_PAYGARANT_NOTIFICATIONDELAY'));
    ...
    public function displayForm()
    {
        ...
        $fields_value['BUCKAROO_PAYGARANT_ENABLED'] = Configuration::get('BUCKAROO_PAYGARANT_ENABLED');
        $fields_value['BUCKAROO_PAYGARANT_TEST'] = Configuration::get('BUCKAROO_PAYGARANT_TEST');
        $fields_value['BUCKAROO_PAYGARANT_DATEDUE'] = Configuration::get('BUCKAROO_PAYGARANT_DATEDUE');
        $fields_value['BUCKAROO_PAYGARANT_SENDMAIL'] = Configuration::get('BUCKAROO_PAYGARANT_SENDMAIL');
        ...
        $fields_value['BUCKAROO_PAYGARANT_USENOTIFICATION'] = Configuration::get('BUCKAROO_PAYGARANT_USENOTIFICATION');
        $fields_value['BUCKAROO_PAYGARANT_NOTIFICATIONDELAY'] = Configuration::get('BUCKAROO_PAYGARANT_NOTIFICATIONDELAY');
        ...
        $fields_form[$i++] = array(
            'legend' => $this->module->l('Payment Guarantee settings'),
            'name' => 'PAYGARANT',
            'test' => Configuration::get('BUCKAROO_PAYGARANT_TEST'),
            'enabled' => Configuration::get('BUCKAROO_PAYGARANT_ENABLED'),
            'input' => array(
                array(
                    'type' => 'enabled',
                    'name' => 'BUCKAROO_PAYGARANT_ENABLED',
                ),
                array(
                    'type' => 'hidearea_start'
                ),
                array(
                    'type' => 'mode',
                    'name' => 'BUCKAROO_PAYGARANT_TEST',
                ),
                array(
                    'type' => 'text',
                    'name' => 'BUCKAROO_PAYGARANT_DATEDUE',
                    'label' => $this->module->l('Number of days between order and invoice'),
                    'smalltext' => $this->module->l('Maximum days of delay 30.'),
                    'size' => 4,
                    'required' => true,
                ...
                array(
                    'type' => 'select',
                    'name' => 'BUCKAROO_PAYGARANT_SENDMAIL',
                    'label' => $this->module->l('Send payment email'),
                    'smalltext' => 'Buckaroo sends an email to the customer with the payment procedures.',
                    'options' => array(
                        array(
                ...
                array(
                    'type' => 'select',
                    'name' => 'BUCKAROO_PAYGARANT_USENOTIFICATION',
                    'label' => $this->module->l('Use notification service'),
                    'smalltext' => $this->module->l(
                            'The notification service can be used to have the payment engine sent additional notifications at certain points. Different type of notifications can be sent and also using different methods to sent them. (PaymentComplete service)'
                        ),
                ...
                array(
                    'type' => 'text',
                    'name' => 'BUCKAROO_PAYGARANT_NOTIFICATIONDELAY',
                    'label' => $this->module->l('Notification delay (in days)'),
                    'smalltext' => $this->module->l(
                            'The time at which the notification should be sent. If this is not specified, the notification is sent immediately.'
                        ),
