...
class BuckarooEpsFlowTest extends BuckarooPaymentServiceFlowTestCase
{
    public function testEpsSimpleFlowReturnsOption(): void
    {
        $config = [
            'eps' => [
                'min_order_amount' => 0,
        ...
        $service = $this->createFlowServiceForMethod('eps', $config);
        ...
        $this->assertSame('eps', $options[0]->getModuleName());
    }
}
