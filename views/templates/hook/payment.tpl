...
{******Payment*Guarantee byJuno*******}
{if $paygarantbyjuno_enabled}
    <div class="row">
        <div class="col-xs-12 col-md-6">
            <p class="payment_module">
                <a id="paygarantbyjuno_enabled"
                   style="background-image: url({$this_path|escape:'quotes':'UTF-8'}views/img/buckaroo_images/byjuno.png)"
                   class="buckaroo_paylink" onclick="paymentMethodValidation.init(this); return false;" rel="booAnimLnk"
                   href="#" title="{l s='Payment Guarantee byJuno' mod='buckaroo3'}">
                    {l s='Payment Guarantee byJuno' mod='buckaroo3'}
                </a>
            </p>
        </div>
    </div>
    <div rel="booAnimBl" class="booBlAnimCont row" style="display: none;">
        <div class="col-xs-12 col-md-6">
            ...
            <form name="booByJunoForm" id="booByJunoForm"
                  action="{$link->getModuleLink('buckaroo3', 'request', ['method' => 'paygarantbyjuno'])|escape:'quotes':'UTF-8'}"
                  method="post">
                ...
                <div class="row row-padding">
                    ...
                    <div class="col-xs-9">
                        ...
                        <input title="Year" name="bjcustomerbirthdate[year]" id="bjcustomerbirthdate_year" type="text"
                               value="{$customer_birthday[0]|escape:'quotes':'UTF-8'}" class="form-control form-control-small"
                               autocomplete="off"/>
                ...
                <div class="row row-padding">
                    <button id="booByJunoSendBtn" type="button" name="processCarrier"
                            class="button btn btn-default button-medium pull-right padding-right-button">
                    <span>
...
{******Payment*Guarantee*******}
{if $paygarant_enabled}
    <div class="row">
        <div class="col-xs-12 col-md-6">
            <p class="payment_module">
                <a id="paygarant_enabled"
                   style="background-image: url({$this_path|escape:'quotes':'UTF-8'}views/img/buckaroo_images/transfergarant.png)"
                   class="buckaroo_paylink" onclick="paymentMethodValidation.init(this); return false;" rel="booAnimLnk"
                   href="#" title="{l s='Pay by Payment Guarantee' mod='buckaroo3'}">
                    {l s='Pay by Payment Guarantee' mod='buckaroo3'}
                </a>
            </p>
        </div>
    </div>
    <div rel="booAnimBl" class="booBlAnimCont row" style="display: none;">
        <div class="col-xs-12 col-md-6">
            ...
            <form name="booGarantForm" id="booGarantForm"
                ...
                <div class="row row-padding">
                    <button id="booGarantSendBtn" type="button" name="processCarrier"
...
{if $afterpay_enabled && ($afterpay_serviss == 'afterpaydigiaccept' || $afterpay_serviss == 'both')}
    <div class="row">
        <div class="col-xs-12 col-md-6">
            <p class="payment_module">
                <a id="afterpay_enabled_digi"
                   ...
                   class="buckaroo_paylink" onclick="paymentMethodValidation.init(this); return false;" rel="booAnimLnk"
                   href="#" title="{l s='Afterpay Digitale Factuur' mod='buckaroo3'}">
                    {l s='Afterpay Digitale Factuur' mod='buckaroo3'}
                </a>
            </p>
        </div>
    </div>
            ...
            <form name="booAfterPayForm_digi" id="booAfterPayForm_digi"
                ...
                {if $afterpay_btb == 'enable' && $customer_company != ''}
                    ...
                    <div class="row row-padding">
                        ...
                        <div class="col-xs-12"><input name="buckaroo-afterpay-CompanyCOCRegistration"
                                                      id="buckaroo-afterpay-CompanyCOCRegistration_digi"
                                                      value="{$customer_company|escape:'html':'UTF-8'}" type="text" class="form-control"/>
                        </div>
                    </div>
                    <div class="row row-padding">
                        <div class="col-xs-12"><label
                                    class="required">{l s='Name of the organization' mod='buckaroo3'}:</label></div>
                        <div class="col-xs-12"><input name="buckaroo-afterpay-CompanyName"
                                                      id="buckaroo-afterpay-CompanyName_digi" value="" type="text"
                                                      class="form-control"/></div>
                    </div>
                    <div class="row row-padding">
                        <div class="col-xs-12">
                            <label
                                    class="required">{l s='Cost center of the order (this will be visible on the invoice)' mod='buckaroo3'}
                                :</label></div>
                        <div class="col-xs-12"><input name="buckaroo-afterpay-CostCentre"
                                                      id="buckaroo-afterpay-CostCentre_digi" value="" type="text"
                                                      class="form-control"/></div>
                    </div>
                    <div class="row row-padding">
                        <div class="col-xs-12"><label
                                    class="required">{l s='VAT (BTW) number' mod='buckaroo3'}:</label></div>
                        <div class="col-xs-12"><input name="buckaroo-afterpay-VatNumber"
                                                      id="buckaroo-afterpay-VatNumber_digi" value="{$customer_vat|escape:'html':'UTF-8'}"
                                                      type="text" class="form-control"/></div>
                    </div>
                {/if}
...
{if $afterpay_enabled && ($afterpay_serviss == 'afterpayacceptgiro' || $afterpay_serviss == 'both')}
    <div class="row">
        <div class="col-xs-12 col-md-6">
            <p class="payment_module">
                <a id="afterpay_enabled_ssd"
                   style="background-image: url({$this_path|escape:'quotes':'UTF-8'}views/img/buckaroo_images/logo_afterpay.jpg)"
                   class="buckaroo_paylink" onclick="paymentMethodValidation.init(this); return false;" rel="booAnimLnk"
                   href="#" title="{l s='Afterpay Eenmalige Machtiging' mod='buckaroo3'}">
                    {l s='Afterpay Eenmalige Machtiging' mod='buckaroo3'}
                </a>
            </p>
        </div>
    </div>
    <div rel="booAnimBl" class="booBlAnimCont row" style="display: none;">
        <div class="col-xs-12 col-md-6">
            ...
            <form name="booAfterPayForm_ssd" id="booAfterPayForm_ssd"
                ...
                <div class="row row-padding">
                    <div class="col-xs-12"><label class="required">{l s='IBAN' mod='buckaroo3'}:</label></div>
                    <div class="col-xs-12"><input name="bpe_afterpay_iban" id="bpe_afterpay_iban_ssd" value=""
                                                  type="text" class="form-control"/></div>
                </div>
                <div class="row row-padding">
                    <div class="col-xs-12"><label class="required">{l s='Invoice person gender' mod='buckaroo3'}
                ...
                <div class="row row-padding" style="padding: 25px 0 0 0">
                    <div class="col-xs-1" style="width: 1%"><input name="bpe_afterpay_accept"
                                                                   id="bpe_afterpay_accept_ssd" value="ON"
                                                                   type="checkbox" class="form-control"/></div>
                    <div class="col-xs-11"><label class="required" for="bpe_afterpay_accept" style="display: inline"><a
                                    href="https://www.afterpay.nl/nl/klantenservice/betalingsvoorwaarden/"
                                    target="_blank"
                ...
                <div class="row row-padding">
                    <button id="booAfterPaySendBtn_ssd" type="button" name="processCarrier"
                            class="button btn btn-default standard-checkout button-medium pull-right padding-right-button">
                <span>
                    {l s='I confirm my order' mod='buckaroo3'}
                    <i class="icon-chevron-right right"></i>
        ...
        <div class="col-xs-12 col-md-6">
            <p class="payment_module">
                <a id="transfer_enabled"
                   ...
                   title="{l s='Pay by Transfer' mod='buckaroo3'}">
                    {l s='Pay by Transfer' mod='buckaroo3'}
                </a>
            </p>
        </div>
    </div>
