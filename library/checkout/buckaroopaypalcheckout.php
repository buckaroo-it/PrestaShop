...
class BuckarooPayPalCheckout extends Checkout
{
    ...
    final public function setCheckout()
    {
        ...
        if ((int)Configuration::get('BUCKAROO_PAYPAL_USENOTIFICATION')) {
            ...
            if ((int)(Configuration::get('BUCKAROO_PAYPAL_NOTIFICATIONDELAY')) > 0) {
                $this->customVars['Notificationdelay'] = date(
                    'Y-m-d',
                    strtotime('now + ' . (int)(Configuration::get('BUCKAROO_PAYPAL_NOTIFICATIONDELAY')) . ' day')
                );
            }
        }
    }
