...
class MisterCashCheckout extends Checkout
{
    ...
    final public function setCheckout()
    {
        ...
        if ((int)Configuration::get('BUCKAROO_MISTERCASH_USENOTIFICATION')) {
            ...
            if ((int)(Configuration::get('BUCKAROO_MISTERCASH_NOTIFICATIONDELAY')) > 0) {
                $this->customVars['Notificationdelay'] = date(
                    'Y-m-d',
                    strtotime('now + ' . (int)(Configuration::get('BUCKAROO_MISTERCASH_NOTIFICATIONDELAY')) . ' day')
                );
            }
        }
    }
